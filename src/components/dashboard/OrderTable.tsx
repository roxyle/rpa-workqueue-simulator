                    ...
                    <tr style={{backgroundColor:"#f0f4f8"}}>
                        {
                            [
                                ...
                                (col)=>(
                                    <th key={col} style={{padding:"6px 8px", textAlign:"left", fontWeight:"500", color:"#666", borderBottom:"1px solid #c8d4e0", whiteSpace:"nowrap"}}>
                                        {col}
                                    </th>
                                )
                            )
                ...
                <tbody>
                    {
                        orders.map(
                            (order)=>(
                                <tr key={order.id} id={`row-${order.idOrdine}`} style={{
                                    opacity:order.statoOrdine==="Spedito"||order.disponibilitaMagazzino==="Attesa fornitore"? 
                                    0.4 : 1}}>
